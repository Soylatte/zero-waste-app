    ...
    <div className="font-sans h-screen flex w-full justify-center items-center bg-green-900">
      <div className="text-center text-white mx-auto">
            ...
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
              <button className="block shadow-lg w-full px-8 py-3 text-base font-medium text-gray-200 hover:text-gray-100 bg-gray-100/10 hover:bg-gray-200/30 hover:backdrop-blur-xl backdrop-blur-lg rounded-md md:py-4 md:text-lg md:px-10">
                Explore
              </button>
              </div>
              </div>
              ...
              <div className="p-1 flex flex-wrap items-center justify-center w-full">
